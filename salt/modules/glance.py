...
def image_delete(id=None, name=None, profile=None):  # pylint: disable=W0622
    '''
...
def image_show(id=None, name=None, profile=None):  # pylint: disable=W0622
    '''
...
def image_list(id=None, profile=None):  # pylint: disable=W0622
    '''
