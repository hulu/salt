...
def submodule(cwd, init=True, opts=None, user=None, identity=None):  # pylint: disable=W0621
    '''
...
def ls_remote(cwd, repository="origin", branch="master", user=None,  # pylint: disable=W0621
